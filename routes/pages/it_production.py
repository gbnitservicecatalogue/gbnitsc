...
it_production_bp = Blueprint('it_production', __name__, url_prefix='/it_production')
...
DATA_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'services_production.json')
...
@it_production_bp.route('/', methods=['GET', 'POST'])
@authenticated
def it_production_index():
    ...
    if request.method == 'POST':
        ...
        new_service = {
            ...
            'ajoute_par': user,
            'assigne_a': request.form.get('assigned_to') 
        }
        ...
        return redirect(url_for('it_production.it_production_index'))
